	...
	public Mono<Void> fillData() {
		return productRepository.findAll().count().flatMap(x -> {
			log.info("Cantidad[X]:" + x);			
				...
				listaProducts
						.add(new Product(Long.valueOf(6),ProductId.TarjetaCreditoEmpresarial, "Tarjeta de Credito", TypeProduct.activos, Long.valueOf(6)));
				listaProducts.add(new Product(Long.valueOf(7),ProductId.TarjetaCreditoPersonal, "Tarjeta de Credito personal", TypeProduct.activos,
						Long.valueOf(7)));
